    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          className="text-5xl md:text-6xl font-bold text-amber-300 text-center"
        >
          조자룡
        </motion.h1>
        ...
        <motion.p
          variants={itemVariants}
          className="text-2xl text-amber-200 text-center"
        >
          趙雲 | 자는 자룡(子龍)
        </motion.p>
        ...
        <motion.div variants={itemVariants} className="space-y-4 text-gray-200">
          ...
          <div className="bg-gray-900/50 rounded-lg p-5 border border-gray-700">
            ...
            <p className="text-lg leading-relaxed">
              ...
              유비와의 만남에서 그의 인생이 완성되었으며, 장판에서 유비의 아내와
              아들을 구출함으로써 영웅의 이름을 떨쳤다.
            </p>
          </div>
          ...
          <div className="bg-gray-900/50 rounded-lg p-5 border border-gray-700">
            ...
            <p className="text-lg leading-relaxed">
              탁월한 무력, 흔들리지 않는 충성심, 절대적인 신뢰. 여든이 넘은
              나이에도 전장에서 활약했으며, 다른 장수들의 비참한 최후와 달리
              의로움 속에서 눈을 감았다.
            </p>
          </div>
          ...
          <div className="bg-amber-900/30 rounded-lg p-5 border border-amber-600">
            ...
            <p className="text-lg leading-relaxed">
              삼국지 정사에는 그의 기록이 짧지만, 나올 때마다 엄청난 임팩트를
              남겼다.
            </p>
            <p className="text-base text-amber-200 mt-3 leading-relaxed">
              ...
              <br />• 최후: 다른 장수들의 비참한 끝과 달리 의로움 속에서
              영광스럽게 마감
            </p>
